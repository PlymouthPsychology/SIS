...
## PsyLab and tutorials

Most modules are supported by Experiential Learning ([**PsyLab**](https://psy.plymouth.ac.uk/psylab)) activities and small group tutorials.
Each PsyLab activity has a deadline to encourage students to complete them in good time, but if students miss these they can ask tutors to give extensions within the PsyLab activities pages.
